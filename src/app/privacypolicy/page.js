  ...
  return (
    <>
      ...
      <div className="p-2 bg-white text-black">
        <h1>Privacy Policy for AM Service Solution</h1>

        <p>
          At AM Service Solution, accessible from
          www.customercareinchennai.com/contactus, one of our main priorities is
          the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by AM Service
        ...
        <p>
          ...
          shared and/or collect in AM Service Solution. This policy is not
          applicable to any information collected offline or via channels other
          than this website. Our Privacy Policy was created with the help of the{" "}
          <a href="https://sanseotools.com/">Privacy Policy Generator</a>.
        </p>
        ...
        <p>
          AM Service Solution follows a standard procedure of using log files.
        ...
        <p>
          AM Service Solution&#39;s Privacy Policy does not apply to other
        ...
        <p>
          AM Service Solution does not knowingly collect any Personal
